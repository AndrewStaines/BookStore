                ...
                <div className="w-fit mx-auto mt-12 bg-[#00000033] border-2 p-12 border-slate-50">
                    <div className=" text-white flex flex-col gap-4">
                        ...
                        <form className="flex flex-col gap-4 text-2xl w-fit mx-auto text-black mt-12">
                            <input type="text" placeholder="Name" id="" className="bg-[#EAF0F7] text-xl px-12  py-3 my-4 rounded-lg w-full focus:outline-none" value={uname} onChange={e => setUname(e.target.value)} />
